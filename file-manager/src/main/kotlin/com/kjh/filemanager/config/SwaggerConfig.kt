...
open class SwaggerConfig {
    private fun swaggerInfo(): ApiInfo {
        return ApiInfoBuilder().title("File manager API")
            .description("File manager API Docs").build()
    }
    ...
    open fun swaggerApi(): Docket {
        return Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors.basePackage("com.kjh.filemanager.controller"))
